...
add_action('woocommerce_review_order_after_order_total', function () {
    ...
    <div id="custom-coupon-box">
        ...
        <button id="apply_custom_coupon" style="padding: 10px 20px; background-color: #af312e; color: #fff; border: none; border-radius: 4px; text-transform: uppercase; cursor: pointer;">Apply Code</button>
