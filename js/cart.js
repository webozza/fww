jQuery(document).ready(function ($) {
  ...
  function makeInstallationClick() {
    ...
    $(".zip-available input").click(function () {
      let totalPrice = $(".order-total .woocommerce-Price-amount bdi").text().replace(",", "");
      ...
      $(".order-total .woocommerce-Price-amount bdi").html(`<span class="woocommerce-Price-currencySymbol">$</span>${newPrice.toLocaleString()}`);
