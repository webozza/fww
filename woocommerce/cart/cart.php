...
function display_zip_code_checker() {
    ...
    <div class="zip-code-check">
        <p>Measuring and Installation available?</p>
    ...
    <script>
        jQuery(document).ready(function($) {
            if ($('body').hasClass('woocommerce-cart')) {
				...
				window.sucess_text =  `<span class="zip-available"><img src="<?php echo esc_js($tick_icon); ?>"> YES, get started  <input type="checkbox" value="false">`;
