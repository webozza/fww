		...
		<tbody>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					?>
					<tr data-product_id='<?= $product_id?>' class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
...
function display_zip_code_checker() {
    ...
    <div class="zip-code-check">
        <p>Installation Available for your order?</p>
    ...
    <script>
        jQuery(document).ready(function($) {
            if ($('body').hasClass('woocommerce-cart')) {
                window.available_zip_codes = "<?php echo esc_js($available_zip_codes); ?>".split(',');
				window.sucess_text =  `<span class="zip-available"><img src="<?php echo esc_js($tick_icon); ?>"> Add installation to your order <input type="checkbox" value="false">`;
				window.unavailable_text = `<span class="zip-not-available"><img src="<?php echo esc_js($cros_icon); ?>"> Unfortunately not at this time</span>`;
